...
router.register(r'accounts', views.AccountAPIView)
router.register(r'activity', views.ActivityAPIView)
router.register(r'activitystatus', views.ActivityStatusAPIView)
router.register(r'contact', views.ContactAPIView)
router.register(r'contactstatus', views.ContactStatusAPIView)
router.register(r'contactsource', views.ContactSourceAPIView)
